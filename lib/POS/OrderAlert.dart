            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 50),
                  //Delivery/Takeaway/mesa
                  (widget.pendingOrders.last.orderType == 'Delivery')
                      ? Icon(
                          Icons.pin_drop,
                          size: 18,
                        )
                  ...
                  SizedBox(width: 5),
                  Text((widget.pendingOrders.last.orderType == 'Delivery')
                      ? '${widget.pendingOrders.last.address}'
                      : '${widget.pendingOrders.last.orderType}'),
                  Spacer(),
                  Text(
                        ...
                        onPressed: () {
                          DatabaseService().saveOrder(
                              ...
                              Colors
                                  ...
                                  .value,
                              (widget.pendingOrders.last.orderType == 'Mesa')
                                  ? true
                                  : false,
                              (widget.pendingOrders.last.orderType ==
                                      'Delivery')

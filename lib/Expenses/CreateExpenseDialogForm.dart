...
class CreateExpenseDialogForm extends StatefulWidget {
  ...
  const CreateExpenseDialogForm(this.costType, this.dropdownCategories,
      this.snapshot, this.removeSupplyFromList, this.addSupplyToList,
      {Key key})
      : super(key: key);
      ...
      children: [
        ...
        ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              if (widget.snapshot.data["Items"][i]['Price'] != null &&
                  widget.snapshot.data["Items"][i]['Quantity'] != null) {
                itemTotal = widget.snapshot.data["Items"][i]['Price'] *
              ...
              return Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Container(
                              ...
                              child: DropdownButton(
                                ...
                                underline: SizedBox(),
                                hint: Text(
                                  widget.snapshot.data["Items"][i]['Category'],
                                  style: TextStyle(
                                ...
                                style: TextStyle(
                                    ...
                                    fontSize: 14,
                                    color: Colors.grey[700]),
                                value: widget.snapshot.data["Items"][i]
                                    ['Category'],
                                items: widget.dropdownCategories.map((x) {
                                  return new DropdownMenuItem(
                                    ...
                                    onTap: () {
                                      setState(() {
                                        categoryInt = widget.dropdownCategories
                                            .indexOf(x);
                                        if (widget.costType ==
                                            'Costo de Ventas') {
                            ...
                            child: Center(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: widget.snapshot.data["Items"][i]
                                      ['Name'],
                                  label: Text(''),
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: TextFormField(
                                ...
                                onChanged: (val) {
                                  bloc.editQuantity(i, double.parse(val));
                                },
                              ),
                            ),
                          ),
                        ...
                        Expanded(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: TextFormField(
                                  initialValue: (widget.snapshot.data["Items"]
                                                  [i]['Price'] !=
                                              null &&
                                          widget.snapshot.data["Items"][i]
                                                  ['Price'] !=
                                          ...
                                          widget.snapshot.data["Items"][i]
                                                  ['Price'] >
                                              0)
                                      ? '\$${widget.snapshot.data["Items"][i]['Price'].toString()}'
                                      : null,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontWeight: FontWeight.w400,
                                  ...
                                  onChanged: (val) {
                                    if (val != null && val != '') {
                                      bloc.editPrice(i, double.tryParse((val)));
                                      // bloc.editPrice(
                                      //     i,
                                      //     double.tryParse(
                                      //         (val.substring(
                        ...
                        IconButton(
                            onPressed: () {
                              ...
                              if (updateSuppliesFromList.containsKey(
                                  widget.snapshot.data["Items"][i]['Name'])) {
                    ...
                    SizedBox(
                        height: (widget.snapshot.data["Items"][i]
                                    ['Base Price'] !=
                                widget.snapshot.data["Items"][i]['Price'])
                            ? 10
                            : 0),
                    //Button
                    ((widget.snapshot.data["Items"][i]['Base Price'] != null) &&
                            (widget.snapshot.data["Items"][i]['Base Price'] !=
                                widget.snapshot.data["Items"][i]['Price']))
                        ? Row(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      if (updateSuppliesFromList.containsKey(
                                          widget.snapshot.data["Items"][i]
                                              ['Name'])) {
                                        updateSuppliesFromList.remove(widget
                                            .snapshot.data["Items"][i]['Name']);
                                        widget.removeSupplyFromList(widget
                                            .snapshot.data["Items"][i]['Name']);
                                      } else {
                                        updateSuppliesFromList[widget.snapshot
                                                .data["Items"][i]['Name']] =
                                            widget.snapshot.data["Items"][i]
                                                ['Price'];
              ...
              child: OutlinedButton(
                ...
                onPressed: () {
                  ...
                  if (widget.costType == 'Costo de Ventas' &&
                    ...
                    bloc.addToExpenseList({
                      'Name': selectedSupplier.initialExpenseDescription,
                      'Price': 0,
                      'Quantity': 1,
                      'Total Price': 0,
                      'Category': (widget.dropdownCategories
                              .contains(selectedSupplier.predefinedAccount))
                          ? selectedSupplier.predefinedAccount

    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
                    ...
                    child: Center(
                        child: Text('Insumo',
                            style: TextStyle(
                              fontSize: 12,
                              color:
                                  searchByVendor ? Colors.grey : Colors.white,
                            ))),
                  ),
                ),
                //Vendor
                    ...
                    child: Center(
                        child: Text('Proveedor',
                            style: TextStyle(
                              fontSize: 12,
                              color:
                                  searchByVendor ? Colors.white : Colors.grey,
                            ))),
                  ),
                ),
                SizedBox(width: 15),
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    NewSupply(widget.currentBusiness, null)));
                      },
                      child: Padding(
          ...
          //List of Products
          Expanded(
              child: (searchByVendor && name != null && name != '')
                  ...
                  : (!searchByVendor && name != null && name != '')
                      ...
                      : StreamProvider<List<Supply>>.value(
                          initialData: null,
                          value: DatabaseService().allSuppliesList(
                              widget.currentBusiness, limitSearch),
                          child: SuppliesList(
                              widget.currentBusiness, loadMore, limitSearch)))
        ],
      ),

      ...
      lineBarsData: [
        LineChartBarData(
          spots: [
            FlSpot(
                0,
                (salesGraphValues!.length > 0)
                    ? salesGraphValues![0].sales!
                    : 0),
            FlSpot(
                1,
                (salesGraphValues!.length > 1)
                    ? salesGraphValues![1].sales!
                    : 0),
            FlSpot(
                2,
                (salesGraphValues!.length > 2)
                    ? salesGraphValues![2].sales!
                    : 0),
            FlSpot(
                3,
                (salesGraphValues!.length > 3)
                    ? salesGraphValues![3].sales!
                    : 0),
            FlSpot(
                4,
                (salesGraphValues!.length > 4)
                    ? salesGraphValues![4].sales!
                    : 0),
            FlSpot(
                5,
                (salesGraphValues!.length > 5)
                    ? salesGraphValues![5].sales!
                    : 0),
            FlSpot(
                6,
                (salesGraphValues!.length > 6)
                    ? salesGraphValues![6].sales!
                    : 0),
          ],
          isCurved: true,
